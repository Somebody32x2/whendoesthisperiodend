...
export let fullSchedule = new FullSchedule(
    ...
    },
    {
        ...
        ], ["3rd Quarter", "4th Quarter"], true, "yellow"),
        semester: new RangesProgressBar("semesters", [[DateTime.fromISO("2024-01-08T15:30"), DateTime.fromISO("2024-05-24T14:15")]], ["2nd Semester"], true, "lime"),
        year: new StaticProgressBar("year", "The School Year", DateTime.fromISO("2023-08-10T08:30"), DateTime.fromISO("2024-05-24T14:15"), true, "green"),
    })